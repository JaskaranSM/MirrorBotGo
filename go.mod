...
require (
	...
	// PINNED: tgbot.InterceptMedia chains the raw update handler by reflecting
	// over gotd/td's tg.UpdateDispatcher internals (via botapi v0.2.0). Do not
	// upgrade gotd/botapi or gotd/td without re-verifying that chain.
	github.com/gotd/botapi v0.2.0
	github.com/gotd/log/logzap v0.1.1
	github.com/gotd/td v0.156.2 // pinned with gotd/botapi (see note above)
